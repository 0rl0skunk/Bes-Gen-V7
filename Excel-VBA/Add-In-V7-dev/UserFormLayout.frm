...
Private pMasstab             As Long
Private MultiPageType        As Long
Private icons                As UserFormIconLibrary

Public Sub load(ByVal Format As String, ByVal Masstab As String, ByVal mpType As Long)
...
Private Sub SpinButtonFormatB_SpinUp()
    ' Spinbutton Breite
    ' If CInt(Me.TextBoxFormatB.value) + 1 > 20 Then Exit Sub ' sizelimit
    Me.TextBoxFormatB.value = Me.TextBoxFormatB.value + 1
    ChangeFormat
...
Private Sub SpinButtonFormatH_SpinUp()
    ' Spinbutton Höhe
    ' If CInt(Me.TextBoxFormatH.value) + 1 > 3 Then Exit Sub ' sizelimit
    Me.TextBoxFormatH.value = Me.TextBoxFormatH.value + 1
    ChangeFormat
