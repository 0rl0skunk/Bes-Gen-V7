...
Private Sub CommandButtonUpgrade_Click()
    ...
    PlankopfFactory.RefreshPlanköpfe
    Unload Me
...
Private Sub Upgrade()
    ...
    Dim shPDataOld           As Worksheet: Set shPDataOld = WBOldVersion.Sheets("Projektdaten"): shPDataOld.Unprotect "Reb$1991"
    Dim shIndexOld           As Worksheet: Set shIndexOld = WBOldVersion.Sheets("Index"): shIndexOld.Unprotect "Reb$1991"
    Dim shStoreDataOld       As Worksheet: Set shStoreDataOld = WBOldVersion.Sheets("Datenbank"): shStoreDataOld.Unprotect "Reb$1991"
    Dim shGebäudeOld         As Worksheet: Set shGebäudeOld = WBOldVersion.Sheets("Gebäude"): shGebäudeOld.Unprotect "Reb$1991"
    Dim shAdresseOld         As Worksheet: Set shAdresseOld = WBOldVersion.Sheets("Adressverzeichnis"): shAdresseOld.Unprotect "Reb$1991"
    On Error GoTo 0
    ...
    Select Case FromVersion
        Case 1
            ...
            With Globals.shPData
                ...
                Globals.shGebäude.range("ADM_ADR_Strasse").value = shPDataOld.range("F5").value
                Globals.shGebäude.range("ADM_ADR_PLZ").value = shPDataOld.range("F6").value
                Globals.shGebäude.range("ADM_ADR_Ort").value = shPDataOld.range("F7").value
        ...
        Case 2
            ...
            For Each Cell In shGebäudeOld.range("B6:AQ95")
                Globals.shGebäude.Cells(Cell.row + 3, Cell.Column).value = Cell.value
            Next Cell
